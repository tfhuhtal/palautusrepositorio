...
class TestKauppa(unittest.TestCase):
    def setUp(self):
        ...
        self.viitegene_mock = Mock(wraps=Viitegeneraattori())
    ...
    def test_osta_kaksi_samaa(self):
        self.viitegeneraattori_mock.uusi.return_value = 42
    ...
    def test_eri_viitenumerot(self):
        ...
        kauppa = Kauppa(self.varasto_mock, self.pankki_mock, self.viitegene_mock)
        ...
        kauppa.aloita_asiointi()
        kauppa.lisaa_koriin(1)
        kauppa.tilimaksu("anakonda", "56665")

        self.pankki_mock.tilisiirto.assert_called_with("anakonda", 3, "56665", "33333-44455", 5)
